...
class AlienInvasion:
    ...
    def __init__(self):
        '''Инициализирует игру и содаёт ресурсы'''
        pygame.init()
        self.settings = Settings()
        self.bg_music = pygame.mixer.Sound('sound/stase_inavders.mp3')
        self.bg_music.play()
    ...
    def _create_fleet(self):
        ...
        # Создание пришельцa и вычесление количества пришельцев в ряду
    ...
    def _update_aliens(self):
        '''Обновляет позиции пришельцев во флоте.'''
